...
function Time({onClick, clicked})
{
    return(
        <>
        <div value="2" onClick={onClick} className={"mt-4 mb-4 min-h-[47px] cursor-pointer flex w-[21.3125rem] border border-white border-1 rounded-lg p-2 flex-col"}>
            <div className="flex justify-between items-center w-[100%]">
            <span className="text-[2rem] text-[var(--text-color)] text-center font-[400]">Time</span>
